...
final class CustomSwitch: UIControl {
    ...
    @IBInspectable public var thumbTintColor: UIColor? {
        didSet {
            if let thumbTintColor = self.thumbTintColor {
                self.onThumbTintColor = thumbTintColor
                self.offThumbTintColor = thumbTintColor
                self.setupUI()
            }
        }
    }
    ...
    @IBInspectable public var onThumbTintColor: UIColor = UIColor.white {
        didSet {
            guard let thumbTintColor = self.thumbTintColor, thumbTintColor == onThumbTintColor else {
                self.setupUI()
                return
            }
        }
    ...
    @IBInspectable public var offThumbTintColor: UIColor = UIColor.white {
        didSet {
            guard let thumbTintColor = self.thumbTintColor, thumbTintColor == offThumbTintColor else {
                self.setupUI()
                return
            }
        }
